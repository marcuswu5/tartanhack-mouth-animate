...
def align(req: AlignRequest):
    ...
    # subprocess.run(["mfa", "align", "/data/audio-transcript", "english_us_arpa", "english_mfa", "/data/alignments"])
    # tg = mytextgrid.read_textgrid('/data/alignments/aligned.TextGrid')
    ...
    # with open('/data/alignments/output.csv', 'w', newline='') as csvfile:
